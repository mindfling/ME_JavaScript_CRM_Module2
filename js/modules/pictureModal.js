...
export const pictureWindow = (width, height, url) => {
  ...
  const win = window.open('about:blank', '', `popup,width=${width},height=${height},left=${winPosX},top=${winPosY}`);
  win.document.body.style.cssText = `
        ...
        height: 100%;
      `;
  win.document.body.innerHTML = `<img src="${url}" alt="image" class="image" style="display:flex;justify-content:center;align-items:center;width:100%;height:100%;object-fit:cover;">`;
